...
#include "../../../../include/c/game_func/d2lang/d2lang_unicode_utf8ToUnicode.h"

#include "../../../../include/c/game_struct/d2_unicode_char.h"
#include "../../../../include/cxx/game_func/d2lang/d2lang_unicode_utf8ToUnicode.hpp"

D2_UnicodeChar* D2_D2Lang_Unicode_utf8ToUnicode(
    D2_UnicodeChar* dest,
    const char* src,
    int count_with_null_term
) {
  auto actual_dest = reinterpret_cast<d2::UnicodeChar*>(dest);
  auto actual_src = reinterpret_cast<const char8_t*>(src);

  auto actual_result = d2::d2lang::Unicode_utf8ToUnicode(
      actual_dest,
      actual_src,
