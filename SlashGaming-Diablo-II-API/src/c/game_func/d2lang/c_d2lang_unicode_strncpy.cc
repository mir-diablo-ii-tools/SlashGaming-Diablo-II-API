...
D2_UnicodeChar* D2_D2Lang_Unicode_strncpy(
  ...
  d2::UnicodeChar* actual_result = d2::d2lang::Unicode_strncpy(
      actual_dest,
      actual_src,
      count
  );
