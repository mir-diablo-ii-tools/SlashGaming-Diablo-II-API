...
std::intptr_t D2Lang_Unicode_strncpy() {
...
UnicodeChar* Unicode_strncpy(
  ...
  std::intptr_t ptr = D2Lang_Unicode_strncpy();

  return D2Lang_Unicode_strncpy_1_00(ptr, dest, src, count);
}
