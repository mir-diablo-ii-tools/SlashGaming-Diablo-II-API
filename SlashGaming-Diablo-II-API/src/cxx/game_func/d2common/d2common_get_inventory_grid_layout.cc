...
D2Common_GetInventoryGridLayout_1_00(
...
__declspec(naked) void __cdecl
D2Common_GetInventoryGridLayout_1_09D(
    std::intptr_t func_ptr,
    std::uint32_t inventory_record_index,
...
std::intptr_t D2Common_GetInventoryGridLayout() {
...
void GetInventoryGridLayout(
    unsigned int inventory_record_index,
    unsigned int inventory_arrange_mode,
    GridLayout* out_grid_layout
) {
  std::intptr_t func_ptr = D2Common_GetInventoryGridLayout();
