...
__declspec(naked) CelFile* __cdecl
D2Win_LoadCelFile_1_00(
...
std::intptr_t D2Win_LoadCelFile() {
...
CelFile* LoadCelFile(
  ...
  std::intptr_t func_ptr = D2Win_LoadCelFile();

  return D2Win_LoadCelFile_1_00(func_ptr, cel_file_name, is_dcc_else_dc6);
}
