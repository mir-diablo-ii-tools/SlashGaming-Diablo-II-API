...
#include "../../../../include/cxx/game_function/storm/storm_s_file_open_archive.hpp"
...
bool SFileOpenArchive(
  ...
  return SFileOpenArchive_1_00(
      mpq_archive_path,
      priority,
      flags,
      reinterpret_cast<MpqArchive_1_00**>(mpq_archive_ptr_out)
  );
}
