...
#ifndef SGD2MAPI_C_INTERFACE_GAME_ADDRESS_H_
#define SGD2MAPI_C_INTERFACE_GAME_ADDRESS_H_

#include "../../include/game_address.h"

struct SGD2MAPI_GameAddress {
  sgd2mapi::GameAddress* game_address;
};

#endif // SGD2MAPI_C_INTERFACE_GAME_ADDRESS_H_
