...
public:
  constexpr explicit GameOrdinal(int ordinal) noexcept
      : ordinal_(ordinal) {
  }

  explicit GameOrdinal(const GameOrdinal& rhs) noexcept = default;
  explicit GameOrdinal(GameOrdinal&& rhs) noexcept = default;

  ~GameOrdinal() noexcept override = default;

  GameOrdinal& operator=(const GameOrdinal& rhs) noexcept = default;
  GameOrdinal& operator=(GameOrdinal&& rhs) noexcept = default;
