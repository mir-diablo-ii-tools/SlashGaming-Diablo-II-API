...
#ifndef SGD2MAPI_GAME_ADDRESS_LOCATOR_C_INTERFACE_GAME_ADDRESS_LOCATOR_INTERFACE_H_
#define SGD2MAPI_GAME_ADDRESS_LOCATOR_C_INTERFACE_GAME_ADDRESS_LOCATOR_INTERFACE_H_
