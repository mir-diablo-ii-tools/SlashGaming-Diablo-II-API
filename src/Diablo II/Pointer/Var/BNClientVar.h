...
#ifndef SGD2MAPI_DIABLOII_POINTER_VAR_BNCLIENTVAR_H_
#define SGD2MAPI_DIABLOII_POINTER_VAR_BNCLIENTVAR_H_
...
#endif // SGD2MAPI_DIABLOII_POINTER_VAR_BNCLIENTVAR_H_
