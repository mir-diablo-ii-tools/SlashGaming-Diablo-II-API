...
#ifndef SGD2MAPI_GAME_PATCH_C_INTERFACE_GAME_BUFFER_PATCH_H_
#define SGD2MAPI_GAME_PATCH_C_INTERFACE_GAME_BUFFER_PATCH_H_
...
struct SGD2MAPI_GameBufferPatch {
  sgd2mapi::GameBufferPatch* game_buffer_patch;
};

#endif // SGD2MAPI_GAME_PATCH_C_INTERFACE_GAME_BUFFER_PATCH_H_
