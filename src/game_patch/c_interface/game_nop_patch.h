...
#ifndef SGD2MAPI_GAME_PATCH_C_INTERFACE_GAME_NOP_PATCH_H_
#define SGD2MAPI_GAME_PATCH_C_INTERFACE_GAME_NOP_PATCH_H_

#include "../../../include/game_patch/game_nop_patch.h"

struct SGD2MAPI_GameNopPatch {
  sgd2mapi::GameNopPatch* game_nop_patch;
};

#endif // SGD2MAPI_GAME_PATCH_C_INTERFACE_GAME_NOP_PATCH_H_
